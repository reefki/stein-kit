...
if ( ! class_exists( 'Stein_Kit_Social_Widget' ) && class_exists( 'WP_Widget' ) ) {
	/**
	 * Social links widget class.
	 *
	 * @since 1.0
	 */
	final class Stein_Kit_Social_Widget extends WP_Widget {
		...
		public function __construct() {
			parent::__construct(
				'stein_kit_social',
				esc_html__( 'Social Links', 'stein-kit' ),
				array(
		...
		public function defaults() {
			return apply_filters(
				'stein_kit_social_widget_defaults',
				array(
					'title' => null,
					'style' => null,
					'limit' => 10,
...
add_action(
	'widgets_init',
	function () {
		register_widget( 'Stein_Kit_Social_Widget' );
	}
);
